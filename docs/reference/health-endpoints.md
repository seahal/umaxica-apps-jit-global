...
The bootstrap GUID profile deliberately declares no database dependency because no authoritative
GUID store exists yet. Its readiness check remains process-local until the persistence boundary is
