...
| --------------------------------------------------------------------- | ----------------- | -------------- | ------------------------- | ---------------- | --------------- | --------------------------------------------------------- |
| `ClientPersona`                                                      | `app_zenith`      | authority      | canonical app Persona resource | target authority | settled      | Concrete app Persona implementation over `personas`; includes the `Persona` interface. |
...
| `PersonaAssignment`                                                   | `app_zenith`      | bridge         | Persona assignment        | target authority | settled         | Transitional Identity-to-Persona access state.            |
...
| model                                                                 | current zenith DB | semantic class | role today               | target placement | decision status | notes                                                                                                             |
| --------------------------------------------------------------------- | ----------------- | -------------- | ------------------------ | ---------------- | --------------- | ----------------------------------------------------------------------------------------------------------------- |
| `Agent`                                                               | `org_zenith`      | authority      | canonical org Persona resource | target authority | settled      | Concrete org Persona implementation over `agents`; includes the `Persona` interface.                             |
...
| `AgentAssignment`                                                     | `org_zenith`      | bridge         | Persona assignment       | target authority | settled         | Transitional Identity-to-Persona access state.                                                                     |
...
| model                                                                 | current zenith DB | semantic class | role today               | target placement | decision status | notes                                                     |
| --------------------------------------------------------------------- | ----------------- | -------------- | ------------------------ | ---------------- | --------------- | --------------------------------------------------------- |
| `Individual`                                                          | `com_zenith`      | authority      | canonical com Persona resource | target authority | settled      | Concrete com Persona implementation over `individuals`; includes the `Persona` interface.                        |
...
| `IndividualAssignment`                                                | `com_zenith`      | bridge         | Persona assignment       | target authority | settled         | Transitional Identity-to-Persona access state.                                                                     |
...
| `AvatarPersonaBinding`                                                                                                                                                                 | `avatar`   | bridge           | Avatar->Persona binding         | current storage  | settled for this phase | Explicit additive bridge remains in avatar.           |
...
| `OperatorOrganization`                                                                  | `org_zenith`               | Legacy org-principal hierarchy container now physically consolidated into zenith.                       | retained legacy model            | It is not the common `Organization` interface or the adopted `Bureau` authority resource.                | High   |
...
| Regional-ready application data | future repository-local application placement candidate                                        | the future Regional repository's application database                  | candidate               |
| Identity binding                | `app_zenith` / `org_zenith` / `com_zenith`                                                   | `zenith`                                                            | settled                 |
| Persona authority               | `app_zenith` / `org_zenith` / `com_zenith`                                                   | surface-local `zenith` authority tables                              | phase-gated             |
| Organization authority          | surface-local concrete resources plus legacy `OperatorOrganization`                           | surface-local `zenith` authority tables                              | phase-gated             |
...
`zenith` already contains the Persona and identity-binding graph for all three surfaces, plus
read-only content rows and RP bridge rows. That graph is the clearest target authority store for
Persona and Identity placement.

`principal` is not the canonical Persona or principal authority store. Regional-ready application
data belongs in the future Regional repository's own application database under its separate
placement decision.
