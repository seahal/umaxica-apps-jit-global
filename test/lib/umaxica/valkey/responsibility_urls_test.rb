...
class UmaxicaValkeyResponsibilityUrlsTest < ActiveSupport::TestCase
  test "parses responsibility URLs and expected nonprod DB indexes from valkey.yml" do
    ...
    assert_equal 5, parsed.db
    assert_equal "127.0.0.1", parsed.host
    assert_equal 6379, parsed.port
    assert_predicate parsed, :redis_scheme?

    assert_equal 1, Umaxica::Valkey::ResponsibilityUrls.expected_db(:cache, env: "development")
    assert_equal 3, Umaxica::Valkey::ResponsibilityUrls.expected_db(:rate_limit, env: "development")
    assert_equal 5, Umaxica::Valkey::ResponsibilityUrls.expected_db(:auth_state, env: "development")
    assert_equal 2, Umaxica::Valkey::ResponsibilityUrls.expected_db(:cache, env: "test")
    assert_equal 4, Umaxica::Valkey::ResponsibilityUrls.expected_db(:rate_limit, env: "test")
    assert_equal 6, Umaxica::Valkey::ResponsibilityUrls.expected_db(:auth_state, env: "test")
  end
